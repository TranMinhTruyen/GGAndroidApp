...
import {Column, FormControl, IconButton, Input, Toast, WarningOutlineIcon,} from 'native-base';
    ...
    return (
        <ScrollView style={{backgroundColor: 'white'}}>
            <View style={styles.body}>
                ...
                <Column style={{flex: 1}} justifyContent={'center'} direction={'column'} width={'100%'}
                    ...
                    <Input InputLeftElement={<Icon color={'#ff0000'} name={'calendar-today'} style={{marginLeft: 10}}/>}
                           InputRightElement={
                               <IconButton
                                   icon={<Icon color={'#ff0000'} name={'edit'} style={{marginRight: 10}}></Icon>}
                    ...
                    <FormControl isInvalid={checkCitizenIDInvalid}>
                        <Input InputLeftElement={<Icon color={'#ff0000'} name={'assignment-ind'}
                                                       style={{marginLeft: 10}}/>}
                               variant={'rounded'}
                               borderWidth={2}
                    ...
                    <FormControl isInvalid={checkCityInvalid}>
                        <Input
                            InputLeftElement={<Icon color={'#ff0000'} name={'location-city'} style={{marginLeft: 10}}/>}
                            variant={'rounded'}
                            borderWidth={2}
                            placeholder={'City'}
                            fontWeight={'bold'}
                                ...
                                <Input InputLeftElement={<Icon color={'#ff0000'}
                                       ...
                                       InputRightElement={
                                           <TouchableOpacity style={{
                                               ...
                                               {
                                                   countDown <= 0 ? <Text
                                                           style={{color: '#ffffff', fontWeight: 'bold'}}>Resend</Text> :
                                                       <Text style={{
                                                           color: '#ffffff',
                                                           fontWeight: 'bold'
                                                       }}>{countDown}</Text>
